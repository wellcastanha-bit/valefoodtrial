...
export default function PainelCarrinho({
  ...
  useEffect(() => {
    if (!cart.isOpen || !hasItems) return;
  ...
  }, [cart.isOpen, hasItems]);

  // ✅ carrinho só existe depois que tiver item
  if (!cart.isOpen || !hasItems) return null;
  ...
  return (
    ...
    >
      ...
      >
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div
                        className="shrink-0 whitespace-nowrap text-[14px] font-extrabold"
                        style={{ color: BRAND }}
                      >
                        {brl(it.price)}
                      </div>
                    ...
                    {isPizza && sabores.length > 0 && (
                      <div
                        className="mt-1 space-y-0.5 text-[12px] font-semibold"
                        style={{ color: BRAND, opacity: 0.78 }}
                      >
                        {sabores.map((s, idx) => (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      style={{
                        ...chipGlass,
                        background:
                          "linear-gradient(180deg, rgba(71,193,224,0.26) 0%, rgba(71,193,224,0.14) 100%)",
        ...
        <div className="sticky bottom-0 px-4 pb-10 pt-3" style={footerGlass}>
          <div
            className="mb-2 flex items-center justify-between text-[13px]"
