      ...
      <div className="mx-auto w-full max-w-[600px] bg-white">
        <div className="px-4 pt-8">
          ...
          <div className="mt-6 space-y-1 text-[16px] sm:text-[18px] font-semibold leading-snug text-black">
            ...
            <div className="flex gap-2">
              <span className="mt-[1px]">🍕</span>
              <span className="min-w-0">Referência em pizza artesanal com massa de longa maturação!</span>
            </div>
            <div className="flex gap-2">
              <span className="mt-[1px]">🕒</span>
              <span className="min-w-0">Todos os dias das 18h às 23h</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6">
          <div className="flex w-full" style={{ background: LINE, gap: "1px" }}>
            ...
            <PromoCardExpanded img="https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&w=900&q=80" />
            <PromoCardExpanded img="https://images.unsplash.com/photo-1541592106381-b31e9677c0e5?auto=format&fit=crop&w=900&q=80" />
          </div>
        </div>
